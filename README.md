...
See PyDrive2 Quickstart for details
...
Note: For Gmail, you must enable App Passwords in your Google Account security settings.

📋 Usage
Load Data: Click "Add Excel File(s)" to import your spreadsheets
Explore: Use the Dashboard tab to create charts and visualizations
Analyze: Switch to the Analysis tab for statistical summaries
Predict: Train ML models in the Prediction tab
Chat: Ask the LLM questions about your data in the LLM Chat tab
Automate: Set up scheduled tasks in the Automation Bot tab
Export: Download or email reports from the Files tab
🤝 Contributing
